...
import distro  # Use distro to replace deprecated platform.linux_distribution()
...
if __name__ == "__main__":
    # Replacing platform.linux_distribution with distro
    if distro.linux_distribution()[0] == "Ubuntu" and distro.linux_distribution()[1] == "16.04":
        main()
